...
Supervisor sẽ tự chạy Node Backend, Python Trading Engine, CI Mini health monitor, tự restart nếu service crash, và gửi Telegram alert khi CI Mini phát hiện lỗi hoặc restart thất bại.
